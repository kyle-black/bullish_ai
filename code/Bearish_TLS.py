...
cursor.execute("""
select id from strategy where name= 'Bearish-Three-Line-Strike'
""")
...
for symbol in symbols:
    ...
    if newest_bar['open'] <= second_newest_bar['close'] and newest_bar['open'] < third_newest_bar['close'] and newest_bar['open'] < fourth_newest_bar["close"]:
        # & newest_bar['high'] > third_newest_bar['high'] & newest_bar['high'] > fourth_newest_bar['high'] & newest_bar['low'] < fourth_newest_bar["low"]:
   ...
   # print(newest_bar, second_newest_bar)
